                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Text('Rp ${bill['total_price'] ?? '85.000'}', style: const TextStyle(fontWeight: FontWeight.bold, color: Color(0xFF0061C9), fontSize: 16)),
                    ],
                  ),
                  const Divider(height: 24),
                  _buildReceiptRow('ID Transaksi', 'HPY-8829-${bill['id'] ?? '4102'}'),
                  _buildReceiptRow('Waktu Pembayaran', 'Hari Ini, 15.15 WIB'),
